...
* When a scanned site exposes a raster logo, a visual showcase Pin passes that actual asset to Gemini as the brand reference. The prompt prohibits invented logos, text, UI, price claims, and badges. The Pin description, rather than generated text baked into the image, explains the connected product capability.
