...
* The first materialized month is October 2026: 90 records per person, including 15 articles, 15 shared Instagram+TikTok carousels, 15 Telegram posts, 15 Threads posts and 30 live Reels. The 30 Reels are unique and distributed evenly across ten formats: lifestyle, property review, lifehack, expert advice, myth check, A/B choice, behind the scenes, one important detail, common question and personal rule. These are planning records, not proof that disconnected channels are ready to publish.
